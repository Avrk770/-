...
- `admin.html` ממשק ניהול מדיה (העלאה, עריכה, מחיקה, פרסום/הסתרה).
...
- ניהול: `http://localhost:8080/admin.html`
...
- `admin.html` כרגע מוגן באמצעות התחברות Supabase; מומלץ לא לפרסם אליו לינק גלוי אם לא צריך.
